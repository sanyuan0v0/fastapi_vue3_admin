...
from app.api.v1.controllers.monitor.task_controller import router as TaskRouter
...
MonitorApiRouter.include_router(router=TaskRouter, prefix="/task", tags=["任务管理模块"])