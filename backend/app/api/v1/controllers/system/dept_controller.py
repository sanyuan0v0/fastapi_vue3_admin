...
async def get_obj_list(
    ...
    result_dict_list = await DeptService.get_dept_list_services(search=search, auth=auth, order_by=page.order_by)
...
async def get_obj_detail(
    ...
    result_dict = await DeptService.get_dept_detail_services(id=id, auth=auth)
...
async def create_obj(
    ...
    result_dict = await DeptService.create_dept_services(data=data, auth=auth)
...
async def update_obj(
    ...
    result_dict = await DeptService.update_dept_services(data=data, auth=auth)
...
async def delete_obj(
    ...
    await DeptService.delete_dept_services(id=id, auth=auth)
...
async def batch_set_available_obj(
    ...
    await DeptService.batch_set_available_services(data=data , auth=auth)
