...
async def get_obj_list(
    ...
    result_dict_list = await MenuService.get_menu_list(search=search, auth=auth)
...
async def get_obj_detail(
    ...
    result_dict = await MenuService.get_menu_detail(id=id, auth=auth)
...
async def create_obj(
    ...
    result_dict = await MenuService.create_menu(data=data, auth=auth)
...
async def update_obj(
    ...
    result_dict = await MenuService.update_menu(data=data, auth=auth)
...
async def delete_obj(
    ...
    await MenuService.delete_menu(id=id, auth=auth)
...
async def batch_set_available_obj(
    ...
    await MenuService.set_menu_available(data=data, auth=auth)
