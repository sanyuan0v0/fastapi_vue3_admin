...
async def get_obj_detail(
    ...
    result_dict = await NoticeService.get_notice_detail_services(id=id, auth=auth)
...
async def get_obj_list(
    ...
    result_dict_list = await NoticeService.get_notice_list_services(auth=auth, search=search, order_by=page.order_by)
...
async def create_obj(
    ...
    result_dict = await NoticeService.create_notice_services(auth=auth, data=data)
...
async def update_obj(
    ...
    result_dict = await NoticeService.update_notice_services(auth=auth, data=data)
...
async def delete_obj(
    ...
    await NoticeService.delete_notice_services(auth=auth, id=id)
...
async def batch_set_available_obj(
    ...
    await NoticeService.set_notice_available_services(auth=auth, data=data)
...
async def export_obj_list(
    ...
    # 获取全量数据
    result_dict_list = await NoticeService.get_notice_list_services(search=search, auth=auth)
