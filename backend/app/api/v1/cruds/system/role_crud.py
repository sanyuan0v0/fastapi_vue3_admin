...
class RoleCRUD(CRUDBase[RoleModel, RoleCreateSchema, RoleUpdateSchema]):
    ...
    async def get_role_by_id(self, id: int) -> Optional[RoleModel]:
        """根据id获取角色信息"""
        return await self.get(id=id)

    async def get_role_list(self, search: Dict = None, order_by: List[Dict[str, str]] = None) -> Sequence[RoleModel]:
        """获取角色列表"""
