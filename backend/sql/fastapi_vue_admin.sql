...
INSERT INTO `system_users` (`id`, `username`, `password`, `name`, `mobile`, `email`, `gender`, `avatar`, `status`, `is_superuser`, `last_login`, `dept_id`, `description`, `created_at`, `updated_at`, `creator_id`) VALUES (2, 'demo', '$2b$12$e2IJgS/cvHgJ0H3G7Xa08OXoXnk6N/NX3IZRtubBDElA0VLZhkNOa', '演示用户', '15382112121', 'demo@qq.com', '1', 'http://service.fastapiadmin.com/api/v1/static/image/avatar.png', 1, 0, NULL, 6, '演示用户', '2025-08-05 00:25:40', '2025-08-05 00:25:40', 1);
COMMIT;
